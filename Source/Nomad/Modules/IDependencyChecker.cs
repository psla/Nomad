...
namespace Nomad.Modules
{
    ...
    {        
        ...
        /// <summary>
        ///     Sorts the given assemblies (<paramref name="modules"/>) set in a dependency resolved loading order.
        /// </summary>
        ...
        ///     On failure populates the <paramref name="nonValidModules"/> set with modules that don't have their dependencies resolved.
        /// </summary>
