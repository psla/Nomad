...
namespace Nomad.Signing.SignatureAlgorithms
{
    ...
    public class RsaSignatureAlgorithm : ISignatureAlgorithm
    {
        ...
        /// <summary>
        /// Signes the data with autogenerated signature
        /// </summary>
        /// <param name="data">The raw data to be signed</param>
        ...
        /// </summary>
        /// <param name="data">Raw data provided</param>
        /// <param name="signature">This data signature</param>
        /// <returns>True if succeeded</returns>
