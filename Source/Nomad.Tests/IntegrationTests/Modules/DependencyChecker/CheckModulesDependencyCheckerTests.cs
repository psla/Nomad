...
namespace Nomad.Tests.IntegrationTests.Modules.DependencyChecker
{
    ...
    public class CheckModulesDependencyCheckerTests : DependencyCheckerBase
    {
        ...
        #region Upgrade Major Versions

        // TODO: write the test with major version upgrade

        #endregion

        // TODO: write multiple failures during update and check if all of them are listed as non valid modules
    }
}